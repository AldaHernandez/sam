...
export default function Nosotros() {
  return (
    <div id="nosotros" className="min-h-screen flex items-center justify-center bg-background px-4 py-8">
      <Card className="bg-secondary w-full max-w-5xl max-h[90vh] md:max-h-[80vh] overflow-y-auto p-6 rounded-2xl shadow-lg">
        <CardBody className="flex flex-col md:flex-row gap-6 items-center">
          <div className="flex flex-col w-full md:w-1/2 gap-4">
            ...
            <h2 className="text-lg md:text-xl font-semibold">Te amo muchísimo🖤</h2>
          </div>
